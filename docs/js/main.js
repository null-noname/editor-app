...
// --- モジュール移行 ---
import { setupDashBoard, renderDashboardList, getAllStatsCache, getAllWorks } from "./modules/dashboard/dashboard.js";
import { showWorkSetup, adjustFormLayout, handleWorkInfoSubmit, initSetupListeners } from "./modules/setup/setup.js";
import {
    openWork,
    closeWorkspace,
    switchWorkspaceTab,
    ...
    toggleWorkInfoMode
} from "./modules/workspace/workspace.js";
